...
export function App() {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-center bg-pattern bg-no-repeat">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
              ...
              <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
                <div className="flex items-center gap-2 flex-1">
                  <button
                    ...
                    type="button"
                    className="bg-transparent text-lg text-zinc-400 outline-none flex-1 flex items-center gap-2"
                  >
        ...
        <p className="text-sm text-zinc-500">
          ...
          com nossos <a href="#" className="text-zinc-300 underline">termos de uso</a> e as <a href="#" className="text-zinc-300 underline">políticas de privacidade</a>.
        </p>
      </div>
            ...
            <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
              <div className="space-y-2">
                ...
                <p className="text-sm text-zinc-400">
                  Os convidados irão receber e-mails para confirmar a paricipação na viagem.
                </p>
                ...
                <form
                  onSubmit={(e) => addNewEmailToInvite(e)}
